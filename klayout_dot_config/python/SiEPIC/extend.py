...
# Path Extension
#################################################################################
pya.Path.snap = snap # gui only
pya.Path.snap_m = snap_m # gui only, function added by Karl McNulty (RIT) for metal pin functionality

# DPath Extension
#################################################################################
pya.DPath.snap = snap # gui only
pya.DPath.snap_m = snap_m # gui only, function added by Karl McNulty (RIT) for metal pin functionality
